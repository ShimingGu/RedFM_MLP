...
exec pixi run python -m aion_magnitude.multiband_morphology_catalogue \
    ...
    --output-catalogue-path "${AION_OUTPUT_CATALOGUE:-/arc/projects/ots/Cosmic_Imprint_of_Time/clauds/catalogs/COSMOS-HSCpipe-Phosphoros_morphological_multiband.fits}" \
    --u-image-dir "${AION_MORPHOLOGY_DIR:-/arc/projects/ots/Cosmic_Imprint_of_Time/clauds/images/tilesv5}" \
    --cache-dir "${AION_MULTIBAND_CACHE_DIR:-/arc/projects/ots/Cosmic_Imprint_of_Time/clauds/cache/aion_multiband_morphology_catalogue}" \
    "$@"
